...
from mcp_vector_search.core.connection_pool import ChromaConnectionPool, PooledConnection
from mcp_vector_search.core.exceptions import ConnectionPoolError
...
class TestChromaConnectionPool:
    ...
    async def test_connection_reuse(self, connection_pool):
        ...
        assert final_stats["connections_created"] <= initial_created + connection_pool._max_connections
    ...
    async def test_pool_statistics(self, connection_pool):
        ...
        required_keys = [
            ...
            "connections_created", "connections_reused", "pool_hits", "pool_misses"
        ]
    ...
    @pytest.mark.asyncio
    async def test_performance_characteristics(self, connection_pool, performance_timer):
